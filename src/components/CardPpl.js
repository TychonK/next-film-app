...
export default function CardPpl(props) {
  ...
  return (
    <Link href={`/people/${personData.id}`}>
      <div className="w-card/sm md:w-card mx-auto rounded-lg md:p-4 hover:scale-105 duration-300 group">
        <img
        ...
        <p className="text-center text-gray-600 mt-1">
          {personData.known_for_department ? personData.known_for_department.replace(
            /ing/g,
            "or"
          ) : ""}
        </p>
